...
<nav className="navbar navbar-expand-lg navbar-light bg-light">
  <div className="container-fluid">
    ...
    <Link to="/" className="nav-link">Achoo</Link>
    </div>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li><Link to="/feature" className="nav-link" >FEATURES</Link></li>
     ...
     <ul class="navbar-nav">
          {userData.id > 0 ? 
          <li><Link to="/login" onClick={handleClick} className="nav-link">SIGNUP</Link></li>
          :
